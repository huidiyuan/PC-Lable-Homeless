...
data <- read_csv("English/09_Original_Data/PC_Pilot-English_Prolific_December 12, 2024_17.20.csv")
View(data)
```
...
cor_stigma_donate <- cor.test(data_main_recode$stigma_avg, data_main_recode$donate_1, method = "spearman")
...
cor_stereotype_donate <- cor.test(data_main_recode$stereotype_avg, data_main_recode$donate_1, method = "spearman")
